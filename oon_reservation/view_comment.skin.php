...
<section id="bo_vc">
    ...
    <?php } ?>
    <?php if ($i == 0) { //댓글이 없다면 ?><p id="bo_vc_empty">등록된 메모가 없습니다.</p><?php } ?>
...
<?php if ($is_comment_write) {
    ...
    <aside id="bo_vc_w">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td>
                    ...
                    <textarea id="wr_content" name="wr_content" required title="메모 내용"
        ...
        <div class="btn_confirm">
            <input type="submit" value="메모등록" id="btn_submit" class="btn_submit" accesskey="s">
        </div>
    ...
    function fviewcomment_submit(f)
    {
        ...
        */
        ...
        if (char_min > 0 || char_max > 0)
        {
            ...
            {
                alert("메모는 "+char_min+"글자 이상 쓰셔야 합니다.");
                return false;
            } else if (char_max > 0 && char_max < cnt)
            {
                alert("메모는 "+char_max+"글자 이하로 쓰셔야 합니다.");
                return false;
            }
        }
